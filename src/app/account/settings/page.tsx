    ...
    <div className="min-h-screen bg-luxury-cream py-12">
      <div className="container-luxury max-w-4xl">
        ...
        >
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-serif text-primary-900 mb-2">Account Settings</h1>
            <p className="text-primary-600">Manage your security and preferences</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-serif text-primary-900">Security</h2>
                  <p className="text-sm text-primary-600">Update your password</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-serif text-primary-900">Email Preferences</h2>
                  <p className="text-sm text-primary-600">Choose what emails you receive</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between py-3 border-b border-primary-200">
                  <div>
                    <p className="font-medium text-primary-900">Order Updates</p>
                ...
                <div className="flex items-center justify-between py-3">
                  <div>
                    <p className="font-medium text-primary-900">Product Updates</p>
                    <p className="text-sm text-primary-600">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-serif text-primary-900">Privacy & Data</h2>
                  <p className="text-sm text-primary-600">Manage your data and privacy</p>
                </div>
              </div>
            ...
            <div className="bg-primary-50 rounded-xl p-6">
              <h3 className="font-semibold text-primary-900 mb-3">Account Status</h3>
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-semibold text-primary-900 font-mono text-xs">{user.id}</p>
                </div>
              </div>
            </div>
          </div>
