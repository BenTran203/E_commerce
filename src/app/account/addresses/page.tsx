...
export default function AddressesPage() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-luxury-cream flex items-center justify-center">
        <p className="text-primary-600">Please log in to manage your addresses.</p>
      </div>
    )
  }
      ...
      <div className="container-luxury max-w-6xl">
        ...
        >
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              <h1 className="text-3xl font-serif text-primary-900 mb-2">Saved Addresses</h1>
              <p className="text-primary-600">Manage your shipping and billing addresses</p>
            </div>
            {!isAddingNew && (
              <Button
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-primary-900">Set as default address</span>
                  </label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {addresses.length === 0 ? (
              <div className="col-span-2 bg-white rounded-xl p-12 text-center">
                ...
                <h3 className="text-xl font-serif text-primary-900 mb-2">No addresses saved</h3>
                <p className="text-primary-600 mb-6">Add an address to speed up checkout</p>
              ...
              addresses.map((address) => (
                ...
                >
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-primary-600 text-sm">{address.country}</p>
                    <p className="text-primary-600 text-sm mt-2">{address.phone}</p>
                  </div>
