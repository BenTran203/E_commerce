        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
                ...
                <form className="space-y-4">
                    ...
                    <button type="button" onClick={(e) => { e.preventDefault(); router.push('/auth?register=true'); }} className="mt-4 text-sm w-full text-gray-500 hover:underline"
                    >
                ...
                <div className="mt-6">
                    <p className="text-center text-sm text-gray-500"> log in with</p>
