        ...
        <div className="container-luxury max-w-4xl">
          ...
          >
            <h2 className="text-2xl font-serif text-primary-900 mb-4">
              {t("legalPages.privacy.intro.title")}
            </h2>
          ...
          >
            <h2 className="text-2xl font-serif text-primary-900 mb-6">
              {t("legalPages.privacy.thirdParty.title")}
            </h2>
            <p className="text-primary-600 leading-relaxed mb-4">
            ...
            <div className="bg-primary-50 p-4 rounded-lg">
              <p className="text-sm text-primary-700">
                <strong>{t("common.thirdPartyServicesInclude")}:</strong>{" "}
                {t("legalPages.privacy.thirdParty.services")}
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-primary-600 leading-relaxed">
              ...
              transfer of your personal data will take place unless there are
          ...
          >
            ...
            <p className="text-primary-600 leading-relaxed">
              ...
              contact us so we can take necessary actions.
            </p>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-2xl font-serif mb-4">
              {t("common.questionsAboutPrivacy")}
            </h2>
