...
import { Truck, Package, RotateCcw, Clock, MapPin, DollarSign, CheckCircle, AlertCircle } from 'lucide-react'
...
export default function ShippingReturnsPage() {
  ...
  const shippingOptions = [
    {
      ...
      description: 'Our standard shipping option provides reliable delivery at an affordable price.'
    },
    {
      icon: Package,
  ...
  const returnSteps = [
    ...
    },
    {
      step: 2,
      title: 'Print Label',
      description: 'Print the prepaid return shipping label provided in your account.'
    },
    {
      step: 3,
      title: 'Pack Items',
      description: 'Securely pack the items in their original packaging with tags attached.'
    },
    {
      step: 4,
      title: 'Ship Back',
    ...
    <div className="min-h-screen bg-luxury-cream">
      ...
      <section className="py-16">
        <div className="container-luxury max-w-6xl">
          ...
          >
            <h2 className="text-3xl font-serif text-primary-900 mb-4">Shipping Options</h2>
            <p className="text-primary-600 max-w-2xl mx-auto">
              Choose the shipping method that works best for you. All orders are trackable and insured.
            </p>
          </motion.div>
            ...
            {shippingOptions.map((option, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-xl font-serif text-primary-900 mb-2">{option.name}</h3>
                  <div className="flex items-center gap-2 mb-4">
                    <Clock size={16} className="text-primary-500" />
                    <span className="text-sm font-medium text-primary-700">{option.time}</span>
                  </div>
                  <div className="flex items-center gap-2 mb-4">
                    <DollarSign size={16} className="text-primary-500" />
                    <span className="text-sm font-semibold text-primary-900">{option.cost}</span>
                  </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3 text-sm text-primary-600">
                  ...
                  <li className="flex items-start">
                    <CheckCircle size={16} className="text-green-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span>All orders ship from our warehouse in California</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle size={16} className="text-green-600 mr-2 flex-shrink-0 mt-0.5" />
            ...
            <div className="mt-8 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-yellow-800 font-medium mb-1">Holiday Shipping Notice</p>
                  <p className="text-sm text-yellow-700">
                    During peak holiday seasons, shipping times may be extended. Please order early to ensure timely delivery.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <h2 className="text-3xl font-serif text-primary-900 mb-4">Easy Returns</h2>
            <p className="text-primary-600 max-w-2xl mx-auto">
              Not completely satisfied? We offer a 30-day return policy for most items. Here's how it works:
            </p>
          </motion.div>
              ...
              {returnSteps.map((step, index) => (
                ...
                >
                  <div className="bg-white rounded-xl p-6 shadow-sm h-full">
                    ...
                    <h3 className="font-semibold text-primary-900 mb-2 text-center">{step.title}</h3>
                    <p className="text-sm text-primary-600 text-center">{step.description}</p>
                  </div>
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl p-8 shadow-sm mb-16"
          >
            <h2 className="text-2xl font-serif text-primary-900 mb-6">Return Policy Details</h2>
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl p-8 shadow-sm mb-16"
          >
            <h2 className="text-2xl font-serif text-primary-900 mb-6">Exchanges</h2>
            <p className="text-primary-600 mb-6">
              Need a different size or color? We make exchanges easy! Simply follow the return process and place a new order for the item you want. If the new item costs less, we'll refund the difference. If it costs more, we'll send you a payment link.
            </p>
            <div className="bg-green-50 border-l-4 border-green-400 p-4 rounded">
              <p className="text-sm text-green-800">
                <strong>Pro Tip:</strong> To ensure you get the item you want, place a new order before returning the original item. This guarantees availability, especially for popular items.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-primary-100 mb-6 max-w-2xl mx-auto">
              Our customer service team is here to assist with any shipping or return questions you may have.
            </p>
