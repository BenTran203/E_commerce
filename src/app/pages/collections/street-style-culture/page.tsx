...
import { ArrowLeft, ShoppingCart, Heart, Star, Zap, TrendingUp } from 'lucide-react'
        ...
        <div className="container-luxury">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">{t('collectionPages.streetStyleCulture.features.urban.title')}</h3>
              <p className="text-primary-600">
                {t('collectionPages.streetStyleCulture.features.urban.description')}
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">{t('collectionPages.streetStyleCulture.features.trending.title')}</h3>
              <p className="text-primary-600">
                {t('collectionPages.streetStyleCulture.features.trending.description')}
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">{t('collectionPages.streetStyleCulture.features.functional.title')}</h3>
              <p className="text-primary-600">
                {t('collectionPages.streetStyleCulture.features.functional.description')}
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-300 mb-6">
                  {t('collectionPages.streetStyleCulture.styleGuide.description')}
                </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 hover:bg-white/20 transition-colors cursor-pointer">
                  <h4 className="font-semibold mb-2">{t('collectionPages.streetStyleCulture.styleGuide.tips.layering.title')}</h4>
                  <p className="text-sm text-gray-300">{t('collectionPages.streetStyleCulture.styleGuide.tips.layering.description')}</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 hover:bg-white/20 transition-colors cursor-pointer">
                  <h4 className="font-semibold mb-2">{t('collectionPages.streetStyleCulture.styleGuide.tips.color.title')}</h4>
                  <p className="text-sm text-gray-300">{t('collectionPages.streetStyleCulture.styleGuide.tips.color.description')}</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 hover:bg-white/20 transition-colors cursor-pointer">
                  <h4 className="font-semibold mb-2">{t('collectionPages.streetStyleCulture.styleGuide.tips.accessories.title')}</h4>
                  <p className="text-sm text-gray-300">{t('collectionPages.streetStyleCulture.styleGuide.tips.accessories.description')}</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 hover:bg-white/20 transition-colors cursor-pointer">
                  <h4 className="font-semibold mb-2">{t('collectionPages.streetStyleCulture.styleGuide.tips.footwear.title')}</h4>
                  <p className="text-sm text-gray-300">{t('collectionPages.streetStyleCulture.styleGuide.tips.footwear.description')}</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container-luxury text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button variant="secondary" className="border-gray-900 text-gray-900 hover:bg-gray-50">
