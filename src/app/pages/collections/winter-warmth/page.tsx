...
import { ArrowLeft, ShoppingCart, Heart, Star, Snowflake } from 'lucide-react'
        ...
        <div className="container-luxury">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">{t('collectionPages.winterWarmth.features.protection.title')}</h3>
              <p className="text-primary-600">
                {t('collectionPages.winterWarmth.features.protection.description')}
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">{t('collectionPages.winterWarmth.features.warmth.title')}</h3>
              <p className="text-primary-600">
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">{t('collectionPages.winterWarmth.features.layering.title')}</h3>
              <p className="text-primary-600">
                {t('collectionPages.winterWarmth.features.layering.description')}
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  <Snowflake size={20} className="text-blue-200 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-semibold mb-1">{t('collectionPages.winterWarmth.care.storage.title')}</h4>
                    <p className="text-sm text-blue-100">{t('collectionPages.winterWarmth.care.storage.description')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  <Star size={20} className="text-blue-200 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-semibold mb-1">{t('collectionPages.winterWarmth.care.cleaning.title')}</h4>
                    <p className="text-sm text-blue-100">{t('collectionPages.winterWarmth.care.cleaning.description')}</p>
                  </div>
                </div>
              </div>
            </div>
