        ...
        <div className="container-luxury">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">{t('collectionPages.formalExcellence.features.tailored.title')}</h3>
              <p className="text-primary-600">
                {t('collectionPages.formalExcellence.features.tailored.description')}
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">{t('collectionPages.formalExcellence.features.fabrics.title')}</h3>
              <p className="text-primary-600">
                {t('collectionPages.formalExcellence.features.fabrics.description')}
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">{t('collectionPages.formalExcellence.features.design.title')}</h3>
              <p className="text-primary-600">
                {t('collectionPages.formalExcellence.features.design.description')}
              </p>
            </motion.div>
          </div>
        </div>
