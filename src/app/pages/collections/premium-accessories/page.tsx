          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">
                {t(
                  "collectionPages.premiumAccessories.features.craftsmanship.title",
                )}
              </h3>
              <p className="text-primary-600">
                {t(
                  "collectionPages.premiumAccessories.features.craftsmanship.description",
                )}
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">
                {t(
                  "collectionPages.premiumAccessories.features.statement.title",
                )}
              </h3>
              <p className="text-primary-600">
                {t(
                  "collectionPages.premiumAccessories.features.statement.description",
                )}
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-serif text-primary-900 mb-2">
                {t(
                  "collectionPages.premiumAccessories.features.investment.title",
                )}
              </h3>
              <p className="text-primary-600">
                {t(
                  "collectionPages.premiumAccessories.features.investment.description",
                )}
              </p>
            </motion.div>
          </div>
