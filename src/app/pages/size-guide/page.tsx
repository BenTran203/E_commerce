...
export default function SizeGuidePage() {
  ...
  const sizeCharts = {
    tops: {
      headers: ['Size', 'US', 'UK', 'EU', 'Chest (in)', 'Waist (in)', 'Length (in)'],
      rows: [
  ...
  const measurementTips = [
    ...
    {
      title: 'Inseam',
      description: 'Measure from the top of your inner thigh down to your ankle bone.',
      icon: Ruler
    }
  ]
    ...
    <div className="min-h-screen bg-luxury-cream">
      ...
      <section className="py-16">
        <div className="container-luxury max-w-6xl">
          ...
          >
            <h2 className="text-3xl font-serif text-primary-900 mb-4">How to Measure Yourself</h2>
            <p className="text-primary-600 max-w-2xl mx-auto">
              For the most accurate measurements, use a soft measuring tape and follow these guidelines.
            </p>
          </motion.div>
            ...
            {measurementTips.map((tip, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-semibold text-primary-900 mb-2">{tip.title}</h3>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-primary-900 mb-2">Measurement Tips</h3>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-primary-900 text-white">
                  <tr>
                    {sizeCharts[activeCategory as keyof typeof sizeCharts].headers.map((header) => (
                ...
                <tbody>
                  {sizeCharts[activeCategory as keyof typeof sizeCharts].rows.map((row, index) => (
                    <tr
                      key={index}
                      ...
                      {row.map((cell, cellIndex) => (
                        <td
                          ...
                          className={`px-6 py-4 text-sm ${
                            cellIndex === 0 ? 'font-semibold text-primary-900' : 'text-primary-600'
                          }`}
                        >
                          {cell}
                        </td>
          ...
          >
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <h3 className="font-semibold text-primary-900 mb-2">Regular Fit</h3>
              <p className="text-sm text-primary-600">
                Our standard fit follows your body's natural lines with room for movement and comfort. Perfect for everyday wear.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-sm text-primary-600">
                A closer fit that follows your body shape more precisely. Tailored for a modern, streamlined silhouette.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <h3 className="font-semibold text-primary-900 mb-2">Relaxed Fit</h3>
              <p className="text-sm text-primary-600">
                Extra room throughout for maximum comfort and ease of movement. Ideal for a laid-back, comfortable style.
              </p>
            </div>
          </motion.div>
