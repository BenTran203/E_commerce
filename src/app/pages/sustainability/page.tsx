  ...
  const commitments = [
    {
      ...
      description:
        "We design products for longevity and recyclability, minimizing waste through innovative circular design principles.",
    ...
    },
    {
      ...
      description:
        "Our manufacturing processes use 70% less water than industry standards through advanced water recycling systems.",
    ...
    },
    {
      ...
      description:
        "We offset 100% of our carbon emissions and are working towards becoming carbon negative by 2030.",
    ...
    },
    {
      ...
      title: "Ethical Labor",
      description:
        "Fair wages, safe working conditions, and respect for workers' rights across our entire supply chain.",
  ...
  const initiatives = [
    {
      ...
      description:
        "Launched 100% recyclable and compostable packaging across all products.",
    ...
    },
    {
      ...
      description:
        "Transitioned all facilities to 100% renewable energy sources.",
  ...
  const goals = [
    {
      ...
      description:
        "Remove more carbon from the atmosphere than we emit through nature-based solutions and innovative technologies.",
    },
    {
      year: "2027",
      goal: "Zero Landfill Waste",
      description:
        "Achieve zero waste to landfill across all operations and product lifecycle through comprehensive recycling programs.",
    },
    {
      year: "2028",
      goal: "100% Sustainable Materials",
      description:
        "Source all materials from sustainable, organic, or recycled sources with full supply chain certification.",
    },
    {
      year: "2030",
      goal: "Industry Leadership",
      description:
        "Set new industry standards for sustainable fashion and help 100+ brands transition to sustainable practices.",
    },
  ];
    ...
    <div className="min-h-screen bg-luxury-cream">
      ...
      <section className="relative py-32 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(rgba(34, 197, 94, 0.8), rgba(21, 128, 61, 0.9)), url("https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=1920&h=1080&fit=crop")',
          }}
        />
        ...
        <div className="relative container-luxury text-center text-white">
          ...
          >
            Building a better future through sustainable practices, ethical
        ...
        <div className="container-luxury max-w-4xl">
          ...
          >
            ...
            <p className="text-lg text-primary-600 leading-relaxed mb-6">
              At Timeless, we believe that fashion should never come at the cost
              of our planet or its people. We're committed to creating
              beautiful, high-quality products while minimizing our
              environmental impact and ensuring ethical practices throughout our
              supply chain.
            </p>
            <p className="text-primary-700 font-medium">
              "Sustainability isn't just part of our business—it's the
        ...
        <div className="container-luxury max-w-6xl">
          ...
          >
            ...
            <p className="text-primary-600 max-w-2xl mx-auto">
              Four pillars guide our sustainability efforts and shape every
              decision we make.
            </p>
          </motion.div>
            ...
            {commitments.map((commitment, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-2xl font-serif text-primary-900 mb-3">
                    {commitment.title}
                  </h3>
      ...
      <section className="py-16 bg-white/50">
        <div className="container-luxury max-w-6xl">
          ...
          >
            ...
            <p className="text-primary-600 max-w-2xl mx-auto">
              Ambitious targets that will transform our industry and protect our
              planet.
            </p>
          </motion.div>
        ...
        <div className="container-luxury max-w-4xl">
          ...
          >
            ...
            <p className="text-primary-600 mb-6">
              We believe in complete transparency about our sustainability
              practices. Download our annual sustainability report to see our
              detailed progress, challenges, and goals.
            </p>
