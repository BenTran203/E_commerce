        ...
        <div className="container-luxury max-w-4xl">
          ...
          >
            <h2 className="text-2xl font-serif text-primary-900 mb-4">
              {t("legalPages.cookies.what.title")}
            </h2>
            ...
            <div className="bg-primary-50 p-4 rounded-lg">
              <p className="text-sm text-primary-700">
                <strong>{t("common.yourControl")}:</strong>{" "}
                {t("legalPages.cookies.what.control")}
              </p>
            </div>
          </motion.div>
                  ...
                  <div className="mt-4 pl-16">
                    ...
                    <ul className="space-y-1">
                      {type.examples.map((example, idx) => (
                        <li
                          key={idx}
                          className="text-sm text-primary-600 flex items-start"
                        >
          ...
          >
            ...
            <p className="text-primary-600 leading-relaxed mb-4">
              ...
              advertisements, and so on. These third parties may use cookies,
              web beacons, and other technologies to collect or receive
              information from our website and use that information to provide
          ...
          >
            <div className="flex items-start gap-4">
              <Trash2
                className="text-primary-900 flex-shrink-0 mt-1"
                size={24}
              />
              <div className="flex-1">
                <h2 className="text-2xl font-serif text-primary-900 mb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-primary-600">
                      Settings → Privacy, search, and services → Cookies and
                      site permissions
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            <p className="text-primary-600 leading-relaxed">
              ...
              service as they move across different websites over time.
              Currently, our website does not respond to DNT signals.
            </p>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-2xl font-serif mb-4">
              {t("common.questionsAboutCookies")}
            </h2>
