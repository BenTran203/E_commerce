  ...
  const pressReleases = [
    {
      ...
      excerpt:
        "New eco-friendly line features recycled materials and carbon-neutral production, setting new industry standards for sustainable fashion.",
    ...
    },
    {
      ...
      excerpt:
        "Company announces strategic expansion into 10 new European countries, bringing luxury sustainable fashion to international customers.",
      category: "Business",
    },
    {
      date: "August 20, 2025",
      ...
      excerpt:
        "Recognized for groundbreaking use of sustainable materials and ethical manufacturing practices at the Global Fashion Summit.",
      category: "Awards",
    },
    {
      date: "July 5, 2025",
      ...
      excerpt:
        "Timeless announces partnership with leading environmental groups to promote sustainable fashion and reduce industry carbon footprint.",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-primary-600 mb-6">
                  Download our comprehensive press kit including high-resolution
                  logos, brand guidelines, product images, and company
                  information.
                </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-md mx-auto">
              <div className="space-y-4 text-left">
                ...
                <div>
                  ...
                  <a
                    href="mailto:press@timeless.com"
                    className="font-semibold hover:text-primary-200 transition-colors"
                  >
                    press@timeless.com
                  </a>
                </div>
        ...
        <div className="container-luxury max-w-4xl">
          ...
          >
            ...
            <p className="text-primary-600 mb-6 max-w-2xl mx-auto">
              Stay informed about our latest news, press releases, and media
              coverage. Subscribe to receive updates directly in your inbox.
            </p>
