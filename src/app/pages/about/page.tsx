    ...
    <div className="min-h-screen bg-luxury-cream">
      ...
      <section className="relative py-20 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(rgba(250, 249, 246, 0.9), rgba(250, 249, 246, 0.9)), url("https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1920&h=1080&fit=crop")',
          }}
        />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-primary-900">
                      {t("about.mission.badge.title")}
                    </p>
                    <p className="text-sm text-primary-600">
                      {t("about.mission.badge.since")}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-white/50">
        <div className="container-luxury">
          ...
          <div className="relative">
            ...
            {["2014", "2016", "2018", "2020", "2022", "2024"].map(
              (year, index) => (
                <motion.div
                  key={year}
                  ...
                  >
                    <div className="bg-white p-6 rounded-xl shadow-sm">
                      ...
                      <p className="text-primary-600">
                        {t(`about.journey.timeline.${year}.description`)}
                      </p>
                    </div>
                  </div>
            ...
            {[
              {
                ...
                image:
                  "https://images.unsplash.com/photo-1526413232644-8a40f03cc03b?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=687",
              },
              {
                name: "David Chen",
                role: "Head of Design",
