        ...
        <div className="container-luxury max-w-4xl">
          ...
          >
            <h2 className="text-2xl font-serif text-primary-900 mb-4">
              {t("legalPages.terms.agreement.title")}
            </h2>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
              <div className="flex items-start">
                ...
                <p className="text-sm text-yellow-800">
                  ...
                  {t("legalPages.terms.agreement.important")}
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-primary-600 leading-relaxed mb-4">
              ...
              software, is the property of Timeless or its content suppliers and
          ...
          >
            ...
            <p className="text-primary-600 leading-relaxed mb-4">
              To the maximum extent permitted by law, Timeless shall not be
          ...
          >
            ...
            <p className="text-primary-600 leading-relaxed">
              ...
              secure, or error-free, or that defects will be corrected. We make
          ...
          >
            ...
            <p className="text-primary-600 leading-relaxed">
              ...
              of the American Arbitration Association, except where prohibited
              by law.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-primary-600 leading-relaxed mb-4">
              ...
              notify you of material changes by posting the new Terms on our
